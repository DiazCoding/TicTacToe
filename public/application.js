...
var createBoard = function createBoard() {
    ...
    for (var i = 0; i < 3; i++) {
        ...
        for (var j = innerLoopCounter * multiply; j < multiply * (innerLoopCounter + 1); j++) {
...
var createClasses = function createClasses() {
    $("tr").addClass("row");
    $("td").addClass("cell");
};
...
var letterSwitcher = function letterSwitcher() {
    letter === "X" ? letter = "O" : letter = "X";
    console.log(letter);
};

var winCons = function winCons() {
...
var handlers = __webpack_require__(6);
...
var renderBoard = function renderBoard(event) {
  event.preventDefault();
